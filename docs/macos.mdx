...
This script automatically downloads, mounts, and installs Ollama to your Applications folder.

See the [automatic installation guide](/auto-install) for more details.

### Manual Installation

Alternatively, [download](https://ollama.com/download/Ollama.dmg) the Ollama app and drag it to your Applications folder.

...
For a fully automated installation, run in PowerShell:

```powershell
irm https://ollama.com/auto-install.ps1 | iex
```

This script automatically downloads and silently installs Ollama to your computer.

See the [automatic installation guide](/auto-install) for more details.

### Manual Installation

Alternatively, [download](https://ollama.com/download/OllamaSetup.exe) and run the installer.
